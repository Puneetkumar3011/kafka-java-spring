...
public class ProductEventController {
    ...
    public ResponseEntity<ProductEvent> createProduct(@RequestBody @Valid ProductEvent productEvent) throws JsonProcessingException, ExecutionException, InterruptedException {
        productEvent.setProductActionType(ProductActionType.NEW);
    ...
    public ResponseEntity<?> updateProduct(@RequestBody @Valid ProductEvent productEvent) throws JsonProcessingException, ExecutionException, InterruptedException {
        /* input validation */
